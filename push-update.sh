...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have HorizonDroid-VERSION-DATE-TYPE-* as format"
...
# Assume HorizonDroid-VERSION-DATE-TYPE-*.zip
...
adb shell "killall org.horizon.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.horizon.updater/databases/updates.db" \
